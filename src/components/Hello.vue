...
export default {
  ...
  mounted () {
    ...
    function zoomed () {
      x.zoomable().domain(currentEvent.transform.rescaleX(zoomableInit).domain())
      y.domain(currentEvent.transform.rescaleY(yInit).domain())
      yPercent.domain(currentEvent.transform.rescaleY(yPercentInit).domain())
